      ...
      <Container>
        ...
        <Content padder>
          ...
          <Card>
            ...
            <CardItem bordered>
              <Text note>
                Leaves should be fully forming, flowers are starting to blossom,
                and the chilis are forming slowly. Give it time to mature and
                soon you will be able to eat
              </Text>
            </CardItem>
            <CardItem bordered>
              <Left>
